  ...
  return (
    <div>
      <footer className="bg-white lg:grid lg:grid-cols-5 dark:bg-gray-900">
        <div className="relative block h-32 lg:col-span-2 sm:h-full lg:h-full">
          <img
            src="/service.jpg"
            alt=""
          ...
          <div className="grid grid-cols-1 gap-8 sm:grid-cols-2">
            <div>
              ...
              <ul className="mt-8 flex gap-6">
                <li>
                  <a
                    href="https://www.facebook.com/share/19MFhLcuVw/"
                    rel="noreferrer"
                    target="_blank"
            ...
            <div className="grid grid-cols-1 gap-4 sm:grid-cols-2">
              <div>
                ...
                <div>
                  <p className="font-medium text-gray-900 dark:text-white mt-10">
                    Aqua Tech RO Sales & Service
                  </p>
          ...
          <div className="mt-12 border-t border-gray-100 pt-12 dark:border-gray-800">
            <div className="sm:flex sm:items-center sm:justify-between">
              ...
              <p className="mt-8 text-xs text-gray-500 sm:mt-0 dark:text-gray-400">
                &copy; {new Date().getFullYear()} Aqua Tech , Dharapuram. All
                rights reserved.
              </p>
            </div>
          </div>
